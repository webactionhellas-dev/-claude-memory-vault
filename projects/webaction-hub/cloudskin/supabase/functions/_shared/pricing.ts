...
export interface CatalogVariant {
  variantId: string;
  priceMajor: number;     // major units in the store's base currency (e.g. 328.00)
  currency: string;       // ISO from Shopify (e.g. "AED"), authoritative base
  ...
  countryOfOrigin?: string | null; // DDP hook
}
