/* ============================================================
   ...
   existing example.com. Guest/bedroom counts & amenity
...
export const site = {
  ...
  phoneDisplay: "+30 210 000 0000",
  whatsapp: "302100000000", // wa.me number, digits only
  address: "Faros Armenistis, Fanari 846 00 · Mykonos, Greece",
  instagram: "https://www.instagram.com/aegeanhouse/",
  instagramHandle: "@aegeanhouse",
  // TODO: point this at your real reservation engine. WhatsApp is a strong default.
  bookingUrl: "https://wa.me/302100000000?text=Hello%2C%20I%27d%20like%20to%20enquire%20about%20a%20private%20stay.",
} as const;
