...
(function () {
  ...
  root.innerHTML =
    ...
    '<div class="vlm-imgtools" id="vlmImg">' +
      ...
      '<div class="vlm-imgtools__drag" id="vlmDragHint">' + svg('<path d="M12 3v18M3 12h18"/><path d="M9 6l3-3 3 3M9 18l3 3 3-3M6 9l-3 3 3 3M18 9l3 3-3 3"/>', 1.7) + ' Drag the dot to reposition</div>' +
  ...
  function revertEdit(id) {
    ...
    else if (e.t === "focal") { var m2 = el('[data-content-img="' + cssq(e.k) + '"]'); if (m2) m2.style.objectPosition = e.orig || ""; queueSave(defObj(e.k + ".pos", "")); }
    else if (e.t === "fade") {
  ...
  function reapplyEdits() {
    Object.keys(EDITS).forEach(function (id) {
      var e = EDITS[id];
      if (e.page !== PAGE && ["text", "img", "focal", "link", "bg", "fade"].indexOf(e.t) >= 0) return;
  ...
  function clearSel() {
    ...
    imgtools.classList.remove("on", "focusing", "uploading", "vlm-repos", "has-fade");
  ...
  function openImageTools(node) {
    ...
    var op = node.style.objectPosition || "";
