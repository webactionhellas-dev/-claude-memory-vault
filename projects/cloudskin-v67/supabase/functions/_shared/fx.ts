...
// Rates are "units of CUR per 1 REFERENCE unit". The table is EUR-referenced
// (rates.EUR === 1), and every conversion is a RATIO rate[target] / rate[base],
// so it stays correct whatever the store base currency is (EUR or AED).
